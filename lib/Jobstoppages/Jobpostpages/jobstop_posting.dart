...
class _JobstopPostingState extends State<JobstopPosting> {
  ...
  List<String> connectionimg = [JobstopPngImg.googlelogo,JobstopPngImg.dribbblelogo,JobstopPngImg.twitterlogo,JobstopPngImg.applelogo,JobstopPngImg.facebooklogo,JobstopPngImg.microsoft];
  List<String> connectionname = ["Google Inc","Dribbble Inc","Twitter Inc","Apple Inc","Facebook Inc","Microsoft Inc"];
  int selected = 0;
  @override
                     ...
                     child: Padding(
                       ...
                       child: Column(
                         ...
                         children: [
                           Row(
                             children: [
                               ...
                               Column(
                                 crossAxisAlignment: CrossAxisAlignment.start,
                                 children: [
                                   Text("Arnold Leonardo",style: dmsbold.copyWith(fontSize: 12,color: Jobstopcolor.black),),
                           ...
                           Text("What are the characteristics of a fake job call form?",style: dmsbold.copyWith(fontSize: 12,color: Jobstopcolor.primarycolor),),
                   ...
                   return InkWell(
                     ...
                     child: Container(
                       ...
                       child: Column(
                         ...
                         children: [
                           Image.asset(connectionimg[index].toString(),height: height/16,),
                           SizedBox(height: height/46,),
                           Text(connectionname[index].toString(),style: dmsbold.copyWith(fontSize: 14,color: Jobstopcolor.primarycolor),),
                           SizedBox(height: height/100,),
                           Text("1M Followers",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.grey),),
                           ...
                           Container(
                            height: height/25,
                             ...
                             decoration: BoxDecoration(
                               ...
                               border: Border.all(color: Jobstopcolor.lightprimary)
                             ),
                             child: Center(
                               child: Text("Follow",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.primarycolor),),
                             ),
                           )
                         ],
                       ),
