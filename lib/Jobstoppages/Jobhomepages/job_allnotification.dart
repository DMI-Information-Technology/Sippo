...
class _AllNotificationState extends State<AllNotification> {
  ...
  int select = 0;
  int selectlist = 0;
  List<String> bottomimg = [JobstopPngImg.deleted,JobstopPngImg.offnotofication,JobstopPngImg.setting];
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text("Applications for Google inc have entered for\ncompany review",
                                  ...
                                  child: Container(
                                    ...
                                    child:  Padding(
                                      padding: EdgeInsets.symmetric(horizontal: width/10,vertical: height/66),
                                        child: Text("Application details",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.white))),),
                                ),
                                Text("25 minutes",style: dmsregular.copyWith(fontSize: 10,color: Jobstopcolor.grey)),
                              ],
                            ),
                          ],
                        ),
