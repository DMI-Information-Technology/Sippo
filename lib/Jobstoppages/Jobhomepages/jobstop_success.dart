            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset(JobstopPngImg.successful1,height: height/4,),
                  SizedBox(height: height/36,),
                  Text("Successful".tr,style: dmsbold.copyWith(fontSize: 16,color: Jobstopcolor.darkgrey),),
                  SizedBox(height: height/46,),
                  Text("Congratulations, your application has been sent".tr,style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.darkgrey),),
                  ...
                  InkWell(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        child:
                        Center(child: Text("Find a similar job".tr,style: dmsbold.copyWith(fontSize: 14,color: Jobstopcolor.primarycolor),)),
                      ),
                    ),
                  ),
                  SizedBox(height: height/36,),
                  InkWell(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        child:
                        Center(child: Text("Back to home".tr,style: dmsbold.copyWith(fontSize: 14,color: Jobstopcolor.white),)),
                      ),
                    ),
                  ),
                ],
