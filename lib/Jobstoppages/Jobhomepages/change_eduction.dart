              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if(type == "1")...[
                      Text("Start date",style: dmsbold.copyWith(fontSize: 16,color: themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
                    ]else ...[
                      Text("End date",style: dmsbold.copyWith(fontSize: 16,color: themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
                    ],
                    Image.asset(JobstopPngImg.enddateimg,height: height/3,),
                    InkWell(
                      onTap: () {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              if(widget.type == "1") ...[
                Text("Change Education",style: dmsbold.copyWith(fontSize: 16,color:themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
              ]else ...[
                Text("Edit Appreciation",style: dmsbold.copyWith(fontSize: 16,color:themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
              ],
              if(widget.type == "1") ...[
                SizedBox(height: height/36,),
                Text("Level of education",style: dmsbold.copyWith(fontSize: 12,color: themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
                SizedBox(height: height/66,),
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                      return const JobstopPosition(type: "4");
                    },));
                  },
                  child: Container(
                      width: width/1,
                      ...
                      child: Padding(
                        ...
                        child: Text("Bachelor of Information Technology",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.darkgrey),),
                      )
                  ),
                ),
                SizedBox(height: height/36,),
                ...
                SizedBox(height: height/36,),
                Text("Award name",style: dmsbold.copyWith(fontSize: 12,color: themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
                SizedBox(height: height/66,),
                Container(
                  height: height/18,
                  decoration: BoxDecoration(
              ...
              if(widget.type == "1") ...[
                Text("Institution name",style: dmsbold.copyWith(fontSize: 12,color: themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
                SizedBox(height: height/66,),
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                  ...
                  child: Container(
                      ...
                      child: Padding(
                        padding:  EdgeInsets.symmetric(horizontal: width/26,vertical: height/66),
                        child: Text("University of Oxford",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.darkgrey),),
                      )
                  ),
                ),
                SizedBox(height: height/36,),
              ]else ...[
                Text("Category/Achievement achieved",style: dmsbold.copyWith(fontSize: 12,color:themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
                SizedBox(height: height/66,),
                Container(
                  height: height/18,
                  decoration: BoxDecoration(
              ...
              if(widget.type == "1")...[
                Text("Field of study",style: dmsbold.copyWith(fontSize: 12,color: themedata.isdark ? Jobstopcolor.white : Jobstopcolor.primarycolor),),
                SizedBox(height: height/66,),
                InkWell(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                  ...
                  child: Container(
                      ...
                      child: Padding(
                        padding:  EdgeInsets.symmetric(horizontal: width/26,vertical: height/66),
                        child: Text("Information Technology",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.darkgrey),),
                      )
                  ),
                ),
                SizedBox(height: height/36,),
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                              ...
                              child:Padding(
                                padding:  EdgeInsets.symmetric(horizontal: width/26,vertical: height/66),
                                child: Text("Sep 2010",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.darkgrey),),
                              )
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                padding:  EdgeInsets.symmetric(horizontal: width/26,vertical: height/66),
                                child: Text("Aug 2013",style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.darkgrey),),
                              )
                          ),
                        ),
                      ],
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: height/26,),
                Text("Remove Education ?",style: dmsbold.copyWith(fontSize: 16,color: Jobstopcolor.primarycolor),),
                SizedBox(height: height/100,),
                Text("Are you sure you want to change what you entered?",
                  style: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.darkgrey),textAlign: TextAlign.center,),
                SizedBox(height: height/26,),
