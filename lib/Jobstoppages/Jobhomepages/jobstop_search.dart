...
import 'package:jobspot/Jobstoppages/Jobhomepages/job_specialization.dart';
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () {
                        ...
                        child: const Icon(Icons.arrow_back_rounded,size: 25,color: Jobstopcolor.white,)),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Padding(
                            padding: const EdgeInsets.all(12.0),
                            child: Image.asset(JobstopPngImg.location,height: height/36,),
                          ),
                          hintStyle: dmsregular.copyWith(fontSize: 12,color: Jobstopcolor.grey),
                          border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(15),
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: selected == index ? Jobstopcolor.primarycolor : Jobstopcolor.greyyy,
                              borderRadius: BorderRadius.circular(10)),
                          child: Center(
                              child: Text(
                                  list[index],
                                  style: dmsregular.copyWith(
                                      fontSize: 12,
                                      color: selected == index ? Jobstopcolor.white :  Jobstopcolor.darkgrey)
                              )),
                        ),
                      );
                    },
             ...
             physics: const NeverScrollableScrollPhysics(),
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Container(
                    margin: EdgeInsets.only(bottom: height/36,right: width/26,left: width/26),
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(15),
                          ...
                          Row(
                            children: [
                              CircleAvatar(
                                ...
                                child: Image.asset(imagelist[index].toString(),height: height/36,),
                              ),
                              const Spacer(),
