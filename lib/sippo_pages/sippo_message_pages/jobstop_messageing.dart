...
class _JobMessageingState extends State<JobMessageing> {
  ...
  List<String> chatimg = [
    JobstopPngImg.photo1,
    JobstopPngImg.photo2,
    JobstopPngImg.photo3,
    JobstopPngImg.photo4,
    JobstopPngImg.photo5,
    JobstopPngImg.photo6
  ];
  List<String> msg = [
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(
                    top: height / 46, bottom: height / 46, right: width / 26),
                        ...
                        Slidable(
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                  radius: 25,
                                  child: Image.asset(chatimg[index],
                                      fit: BoxFit.fill)),
                              SizedBox(
                                width: width / 36,
                              ),
