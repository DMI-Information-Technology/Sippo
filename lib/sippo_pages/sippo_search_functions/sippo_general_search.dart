...
import 'package:sippo/sippo_pages/sippo_search_functions/show_general_search_companies.dart';
import 'package:sippo/sippo_pages/sippo_search_functions/show_general_search_jobs.dart';
    ...
    return AppBar(
      ...
      title: InputBorderedField(
        ...
        hintStyle: dmsregular.copyWith(
          fontSize: FontSize.paragraph(context) - 1,
          color: Colors.grey
        ),
        onTextChanged: (_) {
