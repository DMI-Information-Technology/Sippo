                ...
                children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              "Follow",
                              style: dmsregular.copyWith(
                                  fontSize: 12, color: Jobstopcolor.red),
                            )
                          ],
                        ),
                      ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.symmetric(vertical: height / 116),
                              child: Container(
                                width: width / 3.5,
                                decoration: BoxDecoration(
                  ...
                  if (selected == 0) ...[
                    ...
                    Text(
                      ...
                      style: dmsbold.copyWith(
                          fontSize: 12, color: Jobstopcolor.orenge),
                    ),
                    SizedBox(
                      height: height / 46,
                    ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco labo... Read more",
                                    style: dmsregular.copyWith(
                                        fontSize: 12,
